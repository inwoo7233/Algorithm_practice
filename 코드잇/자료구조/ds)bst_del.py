...
class BinarySearchTree:
    ...
    def delete(self, data):
        ...
        # 경우 3: 지우려는 노드가 2개의 자식이 있을 때
            ...
            successor_node = BinarySearchTree.find_min(node_to_delete.right_child)
            ...
            elif successor_node.parent.right_child == successor_node:
                successor_node.parent.right_child = successor_node.right_child
            if successor_node.right_child is not None:  # successor 노드가 오른쪽 자식이 있을 떄
